...
{
    public partial class frmUMed : Form
    {
        ...
        private void DeleteRecord() 
        {
            ...
            if (MessageBox.Show(String.Format("¿Desea borrar la medida {0} ?", description), "Borrar registro", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                this.Cursor = Cursors.WaitCursor;
